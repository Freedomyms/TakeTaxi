...
import com.yangms.taketaxi.util.GDLocationUtils;
...
//        getCurrentLocation();
    ...
    private void getCurrentLocation(){
        ...
        gdLocationUtils.setLocationUpdateListener(new GDLocationUtils.LocationUpdateListener() {
            @Override
            public void onLocationUpdate(double lat, double lon) {//位置更新执行
            ...
            @Override
            public void onLocationRecord(double lat, double lon) {//每隔几秒执行
                //moveToCurrentLocation();
                mCurLnglat=new LatLng(lon,lat);
               // Log.e("MapActivity",mCurLnglat+"");
